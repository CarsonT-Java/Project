...
public class PlayerAssistant {
	...
	public void giveLife() {
		...
		if (c.duelStatus <= 4) { // if we are not in a duel repawn to wildy
			...
			c.getPA().movePlayer(Settings.DUELING_RESPAWN_X + (Misc.random(Settings.RANDOM_DUELING_RESPAWN)),
					Settings.DUELING_RESPAWN_Y + (Misc.random(Settings.RANDOM_DUELING_RESPAWN)), 0);
			o.getPA().movePlayer(Settings.DUELING_RESPAWN_X + (Misc.random(Settings.RANDOM_DUELING_RESPAWN)),
					Settings.DUELING_RESPAWN_Y + (Misc.random(Settings.RANDOM_DUELING_RESPAWN)), 0);
	...
	/*
	 * public void resetVariables() { c.getCrafting().resetCrafting();
	 * c.usingGlory = false; }
	 */
	...
	public void removeObjects() {
		objectToRemove(2573, 3094);
		objectToRemove(2576, 3096);
		objectToRemove(2542, 3103);
