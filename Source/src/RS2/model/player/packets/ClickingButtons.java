...
import RS2.skills.Crafting.CraftingData.tanningData;
...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(final Client c, int packetType, int packetSize) {
		...
		if ((actionButtonId > 15000 && actionButtonId < 30000) || (actionButtonId == 9110)
				|| (actionButtonId == 10247)) {
		...
		//Monster Teleports Start
				...
				case 152094:
					c.getPA().spellTeleport(2327, 9899, 0);
		...
		case 9178:
			...
			if (c.dialogueAction == 2) {
				...
				c.getDH().sendDialogues(3, c.talkingNpc);
			}
			break;
		...
		case 9179:
			if (c.dialogueAction == 2) {
				...
				c.getDH().sendDialogues(0, c.talkingNpc);
			}
			break;
		...
		case 9181:
			if (c.dialogueAction == 2) {
				if (c.needsNewTask == false) {
					c.getDH().sendDialogues(5, c.talkingNpc);
				} else {
					c.getDH().sendDialogues(6, c.talkingNpc);
				}
			}
			break;
