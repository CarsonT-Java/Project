...
import RS2.skills.Agility;
import RS2.skills.Farming;
import RS2.skills.Firemaking;
import RS2.skills.Fishing;
import RS2.skills.Fletching;
import RS2.skills.Mining;
import RS2.skills.Prayer;
import RS2.skills.Slayer;
import RS2.skills.Thieving;
import RS2.skills.Woodcutting;
import RS2.skills.Runecrafting.Runecrafting;
...
public class Client extends Player {
	...
	private Woodcutting wc = new Woodcutting(this);

	public Firemaking getFiremaking() {
		return fm;
	}

	private Firemaking fm = new Firemaking(this);

	public Mining getMining() {
		return m;
	}

	private Mining m = new Mining(this);

	public Thieving getThieving() {
		return t;
	}

	private Thieving t = new Thieving(this);

	public Runecrafting getRunecrafting() {
		return r;
	}

	private Runecrafting r = new Runecrafting();

	public Fletching getFletching() {
		return f;
	}

	private Fletching f = new Fletching(this);
	...
	private Slayer slay = new Slayer(this);
	...
	public boolean craftingLeather;
	public int miningTimer = 400;
