...
public abstract class Player {
	...
	saveDelay, playerKilled, stotalPlayerDamageDealt, killedBy, lastChatId = 1, privateChat, friendSlot = 0, dialogueId,
			randomCoffin, newLocation, specEffect, specBarId, attackLevelReq, defenceLevelReq, strengthLevelReq,
			rangeLevelReq, magicLevelReq, followId, skullTimer, nextChat = 0, talkingNpc = -1, dialogueAction = 0,
			autocastId, followDistance, followId2, barrageCount = 0, delayedDamage = 0, delayedDamage2 = 0,
			lastArrowUsed = -1, clanId = -1, autoRet = 0, xInterfaceId = 0, xRemoveId = 0, xRemoveSlot = 0,
			frozenBy = 0, poisonDamage = 0, teleAction = 0, bonusAttack = 0, lastNpcAttacked = 0, killCount = 0,
			actionTimer, height = 0;
	...
	public int smeltAmount = 0, smeltEventId = 5567;
	...
	public boolean emoteDone = false;
	public boolean agilityEmote = false;
	public int gnomeObsticle = 0;
	public int wildObsticle = 0;
	public int barbObsticle = 0;
	public boolean isWc;
	...
	public int bowSpecShot, clickNpcType, clickObjectType, objectId, objectX, objectY, objectXOffset, objectYOffset, objectFace,
			objectDistance;
