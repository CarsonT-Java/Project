...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 1:
			...
			"Or I can...", c.talkingNpc, "Duradel");
			c.nextChat = 2;
		break;
		case 2:
			sendOption4("Give me a task.", "I want to cancel my task.", "Exhange points for Slayer EXP", 
			"Where can I complete my task?");
			c.dialogueAction = 2;
		break;
		case 3:
			sendNpcChat1("You have been assigned to kill " + c.taskAmount + " " + GameEngine.npcHandler.getNpcListName(c.slayerTask) + " as a task.", c.talkingNpc, "Duradel");
			c.nextChat = 0;
			break;
		case 4:
			sendNpcChat1("You already have an easy task, complete it first.", c.talkingNpc, "Duradel");
			c.nextChat = 0;
			break;
		case 5:
			sendNpcChat1("You're monster is in " + Slayer.getLocation(c.slayerTask) + ".", c.talkingNpc, "Duradel");
			c.nextChat = 0;
			break;
		case 6:
			sendNpcChat1("You have no task.", c.talkingNpc, "Duradel");
			c.nextChat = 0;
			break;
	}
}
